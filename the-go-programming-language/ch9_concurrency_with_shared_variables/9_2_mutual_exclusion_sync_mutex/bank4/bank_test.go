...
// 在终端执行：
//
//	go test -v ./ch9_concurrency_with_shared_variables/9_2_mutual_exclusion_sync_mutex/bank4

import (
	bank "gopl.io/ch9_concurrency_with_shared_variables/9_2_mutual_exclusion_sync_mutex/bank4"
	"sync"
	"testing"
)
